...
output "gcp_project_id" {
  ...
  description = "GCP project ID — consumed by sibling module Terraform stacks via remote state"
}

output "gcp_region" {
  value       = var.region
  description = "Primary GCP region — consumed by sibling module Terraform stacks via remote state"
}
