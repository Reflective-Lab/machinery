...
| `kenneth-backend-math-base` | deprecated for marquee-apps | `docker/Dockerfile.math-base` (see [Remote Solver Suggestor Pattern](Architecture/Remote%20Solver%20Suggestor%20Pattern.md)) |
...
|---|---|
| [Remote Solver Suggestor Pattern](Architecture/Remote%20Solver%20Suggestor%20Pattern.md) | `marquee-apps/quorum-sense/docs/superpowers/specs/2026-06-14-converge-grpc-suggestor-pattern-design.md` |
